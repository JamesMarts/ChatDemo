package com.example.lijuw.chatdemo;
...
public class MainActivity extends Activity {
    ...
    public static String liantong = "PNtTRJG9lEjIrfeYpZVy6Owc8fil1gVMr17cG81JfCPv7NHdy/74YjqoZkhOVIYYvgUGaIiMg37/TEusauAHZQ==";
    String yidong = "9nnJVBNhNYdXcvW0wf1Fl+vVOHGp/jQLYZ8K2TSAgf0QTS5SqvFHjj2Z62+kDiUh8jvxcqcP93Ox8X9vSQk7Tg==";
...
//        startActivity(new Intent(this, ConversationListActivity.class));
    ...
    public void convers2(View view) {
        RongIM.getInstance().startPrivateChat(this, "10010", "联通");
    }
